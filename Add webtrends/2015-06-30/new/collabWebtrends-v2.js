...
// Created: 6/10/2013 1:00:32 PM
//RJA eSolutions 20130625 modified for Collaboration UAT (see end of this javascript)
function WebTrends(){
	var that=this;
	// begin: user modifiable
	// RJA Oct 2013 - choose dcsid based on domain
	var PRODdcsid="dcs7omvh4rzp97u84zrf2b5h3_9e8i";
	var UATdcsid="dcsbn55zam5vdk3g5a3xumoqc_3j9r";
	var SITdcsid="";
	if(window.location.hostname.toLowerCase().indexOf("sit-")==0)
	{this.dcsid=SITdcsid;}
	if(window.location.hostname.toLowerCase().indexOf("uat-")==0)
	{this.dcsid=UATdcsid;}
	else
	{this.dcsid=PRODdcsid;} //default is PROD
	// end RJA
	this.domain="zstatistics-lb.ch.zurich.com";
	this.timezone=0;
	this.onsitedoms="";
...
WebTrends.prototype.dcsGetId=function(){
	...
	//RJA Sept 2013 this will not work if document already loaded
	//	document.write("<scr"+"ipt type='text/javascript' src='"+"http"+(window.location.protocol.indexOf('https:')==0?'s':'')+"://"+this.domain+"/"+this.dcsid+"/wtid.js"+"'><\/scr"+"ipt>");
	//RJA Sept 2013 so do this instead
	var thisProtocol = "http"+(window.location.protocol.indexOf('https:')==0?'s':'');
	var thisURL= thisProtocol+"://"+this.domain+"/"+this.dcsid+"/wtid.js";
	var thisHead= document.getElementsByTagName('head')[0];
	var thisScript= document.createElement('script');
	thisScript.type= 'text/javascript';
	thisScript.src= thisURL;
...
//eSolutions RJA 20130610 added from html portion of tag
//Requires jquery
$(function() {
// Handler for .ready() called.
//RJA eSolutions 20130626
//Get the business area set in the page and write as a metatag so that WT picks up automatically.
//var someBA;
//try {
//    someBA = $("#wt-ba").find("span")[0].title;
//}
//catch (e) {
//    someBA = "noBA";
//}

//var meta_ContentGroup = document.createElement('meta');
//meta_ContentGroup.name = 'WT.cg_n';
//meta_ContentGroup.content = someBA;
//document.getElementsByTagName('head')[0].appendChild(meta_ContentGroup);
//End meta tags rewrite
//Start WT collection
_tag=new WebTrends();
_tag.dcsGetId();
_tag.dcsCollect();
