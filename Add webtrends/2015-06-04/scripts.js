...
function fBuildLearningFromHistory(){
	...
	str += 'Be inspired by how Zurich has evolved from a Swiss insurer into one of the world’s leading insurance companies.<br><br><a href="https://collaboration.zurich.com/community/00935/01/default.aspx" onclick="javascript:window.open(\'https://collaboration.zurich.com/community/00935/01/default.aspx\',\'History\',\'width=700,height=500\');return false;">More...Visit the Zurich History blog &raquo;</a></div>'
...
function fAddToPlan(ID){
	...
	var WTCourseName = fgetCourseTitle(CourseType, ID);
	WTuriCourse = WTuriAcademy + '/' + WTCourseName;
	dcsMultiTrack('DCS.dcsuri', WTuriCourse, 'WT.es', WTuriCourse, 'WT.ti', WTCourseName, 'WT.dl', '59');
	console.log(WTuriCourse);
...
function fgetCourseTitle(thisCourseType, thisCourseID){
	if(thisCourseType=="Internal"){
	for(var i=0; i<courseData.length; i++){
