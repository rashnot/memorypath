...
function fGetCourseData(academyID){
	console.log(academyID + ' academyID clicked ' + $('#Academy_' + academyID)[0].childNodes[5].outerText);
	courseData = [];
...
function fAddToPlan(ID){
	console.log(ID + '=' + fgetCourseTitle(CourseType, ID) + ' added to plan');
