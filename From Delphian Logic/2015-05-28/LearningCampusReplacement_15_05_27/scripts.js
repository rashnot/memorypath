...
function fBuildLearningFromCustomer(){
	var str = '';
	$('#page-content .content').html('')
	str += '<div style="float:left; width:360px; font-size:110%; margin-right:10px;"><strong>Join-and-learn with General Insurance and Global Life.</strong><br><br>'
	str += 'Learn from what customers say about Zurich. Our customer-facing experts from around the world share what they‘re doing to improve customer care.<br><br><a href="https://www.yammer.com/zurich.com/#/threads/inGroup?type=in_group&feedId=5479177" target="_blank">Visit the Yammer group for more &raquo;</a></div>'
	str += '<div style="float:left;"><img src="../SiteAssets/teddy.jpg" width="250" height="250"></div>'
	$('#page-content .content').html(str)
}
